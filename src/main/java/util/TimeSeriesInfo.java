...
/***
 * Class that prints info about a particular time series
...
public class TimeSeriesInfo {
	...
	public TimeSeriesInfo(File streamDir, File sectorStreamDir) throws IOException{
		timeSeries = loadTimeSeries(Arrays.asList(streamDir,sectorStreamDir));
	}
